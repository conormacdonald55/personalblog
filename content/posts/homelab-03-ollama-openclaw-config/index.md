...
**AI Assistance:** Generated by Claude Sonnet 4.6 (Anthropic) via [Hermes Agent](https://hermes-agent.nousresearch.com). Reviewed by Claude Sonnet 4.6 (Anthropic). The problems, fixes, and test results are the author's own experience.
{{< /alert >}}

...
> **⚠️ Author note:** This is a first draft. Personal note placeholder is marked below — Conor to fill in. Python simulation code is functional scaffold — verify outputs before publishing. Academic DOIs noted as needing verification.

---

## Opening: Something Impossible (That Isn't)
...
That's not science fiction. It's a demonstrated physical phenomenon made possible by a class of materials called **acoustic metamaterials** — and the physics behind it is strange, elegant, and deeply practical.
...
Let's start with a working definition, then sharpen it.
...
**Sharper definition:** Metamaterials are engineered periodic or structured composites whose effective material parameters (density, bulk modulus, refractive index) derive from structural resonance rather than chemical composition — and can take values not found in nature, including negative values.
...
Now imagine that mass-spring system is *inside* a larger structure, and you're observing the whole thing from the outside. You see an external force applied, and you see the outer structure moving in the *opposite* direction. If you tried to describe this bulk behaviour with a simple F=ma relationship, you'd calculate a *negative effective mass*. The mass isn't actually negative — it's just that the internal resonance reverses the observable motion.

This is, at heart, what acoustic metamaterials exploit. Build the right internal resonator geometry, operate near its resonant frequency, and you can make a bulk material exhibit:
...
Everything I described above — band gaps, negative effective properties, resonance-driven attenuation — can be understood starting from a deceptively simple model: a chain of masses connected by springs.
...
Posts 2 and 3 will derive the wave equation from scratch and then show exactly how the spring-mass-damper chain produces the band gap behaviour. We'll build Python simulations you can run and modify yourself. By the end of Post 3, you'll be able to predict where a band gap appears just by looking at the mass and spring constants.
...
[PERSONAL NOTE: Conor will add his own context here — e.g. why he left research, what drew him back, what he hopes to contribute, who he's writing this for. Suggested length: 2–4 sentences. Honest > polished.]

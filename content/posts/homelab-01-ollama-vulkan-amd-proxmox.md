...
**AI Assistance:** This post was written and edited by the author, with AI assistance from Claude Sonnet 4.6 (Anthropic) via [Hermes Agent](https://hermes-agent.nousresearch.com). The research direction, editorial decisions, and code review are the author's own.
{{< /alert >}}

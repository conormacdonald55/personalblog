...
You can see some additional Chart.js examples on the [charts samples](https://blowfish.page/samples/charts/) page.
...
Icons are populated using Hugo pipelines which makes them very flexible. Blowfish includes a number of built-in icons for social, links and other purposes. Check the [icon samples](https://blowfish.page/samples/icons/) page for a full list of supported icons.

Custom icons can be added by providing your own icon assets in the `assets/icons/` directory of your project. The icon can then be referenced in the shortcode by using the SVG filename without the `.svg` extension.

Icons can also be used in partials by calling the [icon partial](https://blowfish.page/samples/icons/).
...
Check out the [mathematical notation samples](https://blowfish.page/samples/mathematical-notation/) page for more examples.
...
You can see some additional Mermaid examples on the [diagrams and flowcharts samples](https://blowfish.page/samples/diagrams-flowcharts/) page.

...
**AI Assistance:** Generated by Claude Sonnet 4.6 (Anthropic) via [Hermes Agent](https://hermes-agent.nousresearch.com). Reviewed by Claude Sonnet 4.6 (Anthropic). The test results, routing decisions, and editorial judgements are the author's own.
{{< /alert >}}
